...
2. **Run the program:**
   ```bash
   java Main <csv_file> <limit_size>
   
## Command Arguments Explained

<csv_file>: Path to your input dataset (e.g., deliveries.csv) . <limit_size>:  Maximum vehicle weight capacity limit in kilograms ($T$), such as 10.
